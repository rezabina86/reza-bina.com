...
Then a bug sent me looking. Tap the play button twice quickly and the app would jump to the next question before you'd answered the current one. Small, silly, easy to reproduce.
