...
draft: false
tags: ["Swift Concurrency", "Combine"]
---
...
Fixing it took an afternoon, deleted about 1,700 lines, and removed every last trace of Combine from the app. This is the story of that migration: what moved, what broke on the way, and the uncomfortable part I keep coming back to, which is that the migration itself is not what fixed the bug.
...
## The bug the migration had to fix
