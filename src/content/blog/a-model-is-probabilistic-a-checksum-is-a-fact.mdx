...
The second instinct is document frequency — a term repeated twenty times is boilerplate. That one is worse. In the document that motivated this work, the most-repeated proper noun *was the owner's own name*. Frequency suppression would have specifically suppressed the single most important thing on the page.
