...
# TODO(reza): set pubDate to Veil's App Store launch day before publishing.
pubDate: 2026-08-05
draft: true
...
Veil is on the App Store if you want to see the pipeline from the outside. {/* TODO(reza): App Store URL */}
