...
That's the portfolio I'm building: a few apps that do one thing well, keep your data on your device, and are still yours when the servers go dark. ZumNum is the first on the App Store, and Veil is next. If "we never see your data" is going to mean anything, it should be something you can check from the outside, not something you have to take my word for.
